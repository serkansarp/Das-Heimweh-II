...
"duzce" };
	string ozellik[244] = { "0",
		...
		/* 02-adiyaman */			"Güneydoğu Anadolu Bölgesi'ndedir.","bu","o",
		/* 03-afyonkarahisar */		"Ege Bölgesi'ndedir.","bu","o",
		/* 04-agri */				"Doğu Anadolu Bölgesi'ndedir.","bu","o",
		/* 05-amasya */				"Karadeniz Bölgesi'ndedir.","bu","o",
		/* 06-ankara */				"İç Anadolu Bölgesi'ndedir.","Anıtkabir bu ilde bulunur.","Türkiye'nin başkentidir.",
		/* 07-antalya */			"Akdeniz Bölgesi'ndedir.","bu","o",
		/* 08-artvin */				"Karadeniz Bölgesi'ndedir.","bu","o",
		/* 09-aydin */				"Ege Bölgesi'ndedir.","bu","o",
		/* 10-balikesir */			"Marmara Bölgesi'ndedir.","bu","o",
		/* 11-bilecik */			"Marmara Bölgesi'ndedir.","bu","o",
		/* 12-bingol */				"Doğu Anadolu Bölgesi'ndedir.","bu","o",
		/* 13-bitlis */				"Doğu Anadolu Bölgesi'ndedir.","bu","o",
		/* 14-bolu */				"Karadeniz Bölgesi'ndedir.","bu","o",
		/* 15-burdur */				"Akdeniz Bölgesi'ndedir.","bu","o",
		/* 16-bursa */				"Marmara Bölgesi'ndedir.","bu","o",
		/* 17-canakkale */			"Marmara Bölgesi'ndedir.","bu","o",
		/* 18-cankiri */			"İç Anadolu Bölgesi'ndedir.","bu","o",
