...
"duzce" };
	string ozellik[244] = { "0",
		...
		/* 22-edirne */				"Marmara Bölgesi'ndedir.","Meşhur yiyecekleri arasında tava ciğeri de bulunur.","Kavala Kurabiyesi'nin merkezidir.",
		/* 23-elazig */				"Doğu Anadolu Bölgesi'ndedir.","Dünyada şarap üretiminin merkezlerindendir.","Cevizli sucuk, burada Orcik ismiyle anılır.",
		/* 24-erzincan */			"Doğu Anadolu Bölgesi'ndedir.","Tulum peyniri denince ilk akla gelen ildir.","Yaprak döneri ile ünlüdür.",
		/* 25-erzurum */			"Doğu Anadolu Bölgesi'ndedir.","Palandöken Dağı bu ildedir.","Cağ Kebabı buradan çıkmadır.",
		/* 26-eskisehir */			"İç Anadolu Bölgesi'ndedir.","Gidildiğinde ilk ziyaret edilmesi gereken yerler'den biri Odunpazarı'dır.","Çibörek bilinen lezzetlerindendir.",
		...
		/* 29-gumushane */			"Karadeniz Bölgesi'ndedir.","Katıklı Çorbası'nın ayrı bir tadı vardır.","Limni Gölü mutlaka ziyaret edilmelidir.",
		/* 30-hakkari */			"Doğu Anadolu Bölgesi'ndedir.","bu","o",
		/* 31-hatay */				"Akdeniz Bölgesi'ndedir.","XXXXXX","Merkez ilçesi Antakya'nın adı yanlışıkla ilin adı olarak da kullanılır.",
		/* 32-isparta */			"Akdeniz Bölgesi'ndedir.","bu","o",
		/* 33-icel */				"Akdeniz Bölgesi'ndedir.","XXXXXX","Merkez ilçesi Mersin'in adı yanlışlıkla ilin adı olarak da kullanılır.",
		...
		/* 41-kocaeli */			"Marmara Bölgesi'ndedir.","bu","Merkez ilçesi İzmit'in adı yanlışlıkla ilin adı olarak da kullanılır.",
		...
		/* 46-kahramanmaras */		"Akdeniz Bölgesi'ndedir.","bu","1925'te adının başına Kahraman unvanı almıştır.",
		...
		/* 54-sakarya */			"Marmara Bölgesi'ndedir.","bu","Merkez ilçesi İzmit'in adı yanlışlıkla ilin adı olarak da kullanılır.",
		...
		/* 63-sanliurfa */			"Güneydoğu Anadolu Bölgesi'ndedir.","XXXXXX","1984'te adının başına Şanlı unvanı almıştır.",
